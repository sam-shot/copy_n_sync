...
class _$_Register implements _Register {
  const _$_Register({this.message, this.data, this.status});
  ...
  @override
  String toString() {
    return 'Register(message: $message, data: $data, status: $status)';
  }
...
abstract class _Register implements Register {
  const factory _Register(
      {final String? message,
      final Data? data,
      final String? status}) = _$_Register;
...
class _$_Data implements _Data {
  const _$_Data({this.name, this.email, this.username, this.password});
  ...
  @override
  String toString() {
    return 'Data(name: $name, email: $email, username: $username, password: $password)';
  }
